...
public class PanelEliminar_p extends JPanel implements ActionListener{
	...
	PanelEliminar_p(Controlador ctrl)
	{
		...
		if(btnpuch==bot_bus)
		{
			...
			try
			{
				...
				boolean very= true;
					...
					{
						con++;
						if(producto.getCod_p()==Integer.parseInt(introbus.getText()))
						{
							very=false;
							//System.out.println(producto.getCod_p()+" "+producto.getNom_p()+" "+producto.getPre_p());
							info[5].setText(String.valueOf(producto.getCod_p()));
							info[6].setText(producto.getNom_p());
							info[7].setText(String.valueOf(producto.getPre_p()));
						}
